...
# I will fill these values with mean.
#fix_na(housing,'reception_rooms', '0')
...
# I will fill these values with mean.
#fix_na(housing,'broadband_speed', '0')
fix_na(housing, 'area', housing['area'].mean())
...
#I will fill these values with mean.
#fix_na(housing,'page_views_30_days', '0')
...
# I will fill these values with mean.
#fix_na(housing,'page_views_total', '0')
...
# Finding the Outliers
housing[(housing['reception_rooms'] > 4.081130799247788) | (housing['reception_rooms'] < -0.5459165325456319)]
print(housing[(housing['reception_rooms'] > 4.081130799247788) | (housing['reception_rooms'] < -0.5459165325456319)])
# Trimming of Outliers
new_housing = housing[(housing['reception_rooms'] < 4.081130799247788) & (housing['reception_rooms'] > -0.5459165325456319) ]
new_housing
#Capping on Outliers
...
# Finding the Outliers
housing[(housing['page_views_30_days'] > 1613.2343567716357) | (housing['page_views_30_days'] < -1103.778458790764)]
print(housing[(housing['page_views_30_days'] > 1613.2343567716357) | (housing['page_views_30_days']
                                                                      < -1103.778458790764)])
# Trimming of Outliers
new_housing = housing[(housing['page_views_30_days'] < 1613.2343567716357) & (housing['page_views_30_days'] >
                                                                              -1103.778458790764) ]
new_housing
#Capping on Outliers
...
# Finding the Outliers
housing[(housing['page_views_total'] > 8818.220281853784) | (housing['page_views_total'] < -5391.317468267865)]
print(housing[(housing['page_views_total'] > 8818.220281853784) | (housing['page_views_total'] < -5391.317468267865)])
# Trimming of Outliers
new_housing = housing[(housing['page_views_total'] < 8818.220281853784) & (housing['page_views_total'] > -5391.317468267865) ]
new_housing
#Capping on Outliers
